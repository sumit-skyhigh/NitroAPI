...
# Check if the project name is not empty or contains only valid alphanumeric characters and underscores
...
# Create basic files with TODO comments
...
"@
Set-Content "$projectName/src/$projectName.Api/Controllers/AccountController.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Helpers/Extensions.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/GlobalUsing.cs" -Value $initialContent
...
app.Run();
"@
Set-Content "$projectName/src/$projectName.Api/Program.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Services/TokenService.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Data/ApplicationDBContext.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Models/AppUser.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Dtos/Account/RegisterDto.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Dtos/Account/LoginDto.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/Dtos/Account/NewUserDto.cs" -Value $initialContent
...
Set-Content "$projectName/src/$projectName.Api/Interfaces/ITokenService.cs" -Value $initialContent
...
"@
Set-Content "$projectName/src/$projectName.Api/appsettings.json" -Value $initialContent
